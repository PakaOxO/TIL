...
![Repo 권한 지정|600](repo_option.png)
...
![젠킨스 깃허브 토큰 등록|600](jenkins_setting.png)
...
![깃허브 서버 등록|600](jenkins_githubserver.png)

![깃허브 서버 등록|600](githubserver_token.png)
...
![젠킨스-깃허브 연결테스트|](jenkins_conn_test.png)
...
![매개변수 추가|600](parameter_setting.png)
...
![매개변수 추가|600](pipeline_script.png)
...
![Node 플러그인 설치|600](plugin_setting01.png)
...
![깃 설정|600](git_setting.png)

![Node 설정|](node_setting.png)
...
![Github integration 플러그인 설치|600](github_plugin.png)
...
![Repo Webhook 설정|600](AWS/images/repo_webhook.png)
