...
![Repo 권한 지정|600](./images/repo_option.png)
...
![젠킨스 깃허브 토큰 등록|600](./images/jenkins_setting.png)
...
![깃허브 서버 등록|600](./images/jenkins_githubserver.png)

![깃허브 서버 등록|600](./images/githubserver_token.png)
...
![매개변수 추가|600](./images/parameter_setting.png)
...
![매개변수 추가|600](./images/pipeline_script.png)
...
![Node 플러그인 설치|600](./images/plugin_setting01.png)
...
![깃 설정|600](./images/git_setting.png)
...
![Github integration 플러그인 설치|600](./images/github_plugin.png)
...
![Repo Webhook 설정|600](./images/repo_webhook.png)
...
>[!caution] **warning** Credentials에 등록한 설정이 나오지 않을 경우
>
